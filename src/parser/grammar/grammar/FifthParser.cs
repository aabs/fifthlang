...
public partial class FifthParser : FifthParserBase {
	...
	public const int
		...
		STRUCT=31, SWITCH=32, TYPE=33, VAR=34, WHILE=35, WITH=36, TRUE=37, FALSE=38, 
	...
	private static readonly string[] _LiteralNames = {
		...
		"'sparql_store'", "'store'", "'struct'", "'switch'", "'type'", "'var'", 
		"'while'", "'with'", "'true'", "'false'", "'null'", null, "'('", "')'", 
		"'{'", "'}'", "'<{'", "'}>'", "'['", "']'", "'='", "','", "';'", "':'", 
		"'.'", "'++'", "'--'", "'+='", "'**'", "':='", "'...'", "'<-'", "'_'", 
		"'!'", "'||'", "'&&'", "'!&'", "'!|'", "'~'", "'=='", "'!='", "'<'", "'<='", 
		"'>'", "'>='", "'|'", "'/'", "'%'", "'<<'", "'>>'", "'^'", "'+'", "'-'", 
	...
	private static readonly string[] _SymbolicNames = {
		...
		"TYPE", "VAR", "WHILE", "WITH", "TRUE", "FALSE", "NIL_LIT", "IDENTIFIER", 
	...
	private static int[] _serializedATN = {
		4,1,127,618,2,0,7,0,2,1,7,1,2,2,7,2,2,3,7,3,2,4,7,4,2,5,7,5,2,6,7,6,2,
		...
		96,98,100,102,104,106,108,110,112,114,116,118,0,7,3,0,54,55,62,62,80,81,
		3,0,57,57,75,78,82,83,3,0,67,67,74,74,80,81,1,0,68,73,1,0,54,55,1,0,37,
		38,2,0,89,89,92,92,646,0,121,1,0,0,0,2,148,1,0,0,0,4,150,1,0,0,0,6,154,
		...
		0,0,149,3,1,0,0,0,150,151,5,23,0,0,151,152,3,8,4,0,152,153,5,51,0,0,153,
		5,1,0,0,0,154,155,5,19,0,0,155,156,3,8,4,0,156,157,5,51,0,0,157,7,1,0,
		0,0,158,163,5,40,0,0,159,160,5,53,0,0,160,162,5,40,0,0,161,159,1,0,0,0,
		162,165,1,0,0,0,163,161,1,0,0,0,163,164,1,0,0,0,164,9,1,0,0,0,165,163,
		1,0,0,0,166,167,5,40,0,0,167,11,1,0,0,0,168,169,5,1,0,0,169,170,3,10,5,
		0,170,171,5,2,0,0,171,172,3,110,55,0,172,173,5,51,0,0,173,13,1,0,0,0,174,
		175,3,18,9,0,175,184,5,41,0,0,176,181,3,22,11,0,177,178,5,50,0,0,178,180,
		...
		186,1,0,0,0,186,187,5,42,0,0,187,188,5,52,0,0,188,189,3,32,16,0,189,190,
		3,16,8,0,190,15,1,0,0,0,191,192,3,34,17,0,192,17,1,0,0,0,193,194,5,40,
		0,0,194,19,1,0,0,0,195,196,5,74,0,0,196,197,3,72,36,0,197,21,1,0,0,0,198,
		199,3,58,29,0,199,200,5,52,0,0,200,203,3,32,16,0,201,204,3,20,10,0,202,
		204,3,24,12,0,203,201,1,0,0,0,203,202,1,0,0,0,203,204,1,0,0,0,204,23,1,
		0,0,0,205,206,5,43,0,0,206,211,3,26,13,0,207,208,5,50,0,0,208,210,3,26,
		13,0,209,207,1,0,0,0,210,213,1,0,0,0,211,209,1,0,0,0,211,212,1,0,0,0,212,
		214,1,0,0,0,213,211,1,0,0,0,214,215,5,44,0,0,215,25,1,0,0,0,216,217,5,
		40,0,0,217,218,5,52,0,0,218,221,5,40,0,0,219,222,3,20,10,0,220,222,3,24,
		12,0,221,219,1,0,0,0,221,220,1,0,0,0,221,222,1,0,0,0,222,27,1,0,0,0,223,
		224,5,5,0,0,224,227,5,40,0,0,225,226,5,11,0,0,226,228,3,32,16,0,227,225,
		1,0,0,0,227,228,1,0,0,0,228,231,1,0,0,0,229,230,5,20,0,0,230,232,3,116,
		58,0,231,229,1,0,0,0,231,232,1,0,0,0,232,233,1,0,0,0,233,238,5,43,0,0,
		...
		0,0,0,241,242,5,44,0,0,242,29,1,0,0,0,243,244,5,40,0,0,244,245,5,52,0,
		0,245,246,3,68,34,0,246,247,5,51,0,0,247,31,1,0,0,0,248,249,5,40,0,0,249,
		33,1,0,0,0,250,254,5,43,0,0,251,253,3,40,20,0,252,251,1,0,0,0,253,256,
		1,0,0,0,254,252,1,0,0,0,254,255,1,0,0,0,255,257,1,0,0,0,256,254,1,0,0,
		0,257,258,5,44,0,0,258,35,1,0,0,0,259,263,5,45,0,0,260,262,3,40,20,0,261,
		260,1,0,0,0,262,265,1,0,0,0,263,261,1,0,0,0,263,264,1,0,0,0,264,266,1,
		0,0,0,265,263,1,0,0,0,266,267,5,46,0,0,267,37,1,0,0,0,268,271,3,56,28,
		0,269,270,5,49,0,0,270,272,3,72,36,0,271,269,1,0,0,0,271,272,1,0,0,0,272,
		273,1,0,0,0,273,274,5,51,0,0,274,39,1,0,0,0,275,287,3,34,17,0,276,287,
		...
		41,1,0,0,0,288,289,3,36,18,0,289,290,5,51,0,0,290,43,1,0,0,0,291,295,3,
		72,36,0,292,296,5,49,0,0,293,296,5,56,0,0,294,296,5,87,0,0,295,292,1,0,
		0,0,295,293,1,0,0,0,295,294,1,0,0,0,296,297,1,0,0,0,297,298,3,72,36,0,
		298,299,5,51,0,0,299,45,1,0,0,0,300,302,3,72,36,0,301,300,1,0,0,0,301,
		302,1,0,0,0,302,303,1,0,0,0,303,304,5,51,0,0,304,47,1,0,0,0,305,306,5,
		18,0,0,306,307,5,41,0,0,307,308,3,72,36,0,308,309,5,42,0,0,309,312,3,40,
		20,0,310,311,5,10,0,0,311,313,3,40,20,0,312,310,1,0,0,0,312,313,1,0,0,
		0,313,49,1,0,0,0,314,315,5,27,0,0,315,316,3,72,36,0,316,317,5,51,0,0,317,
		51,1,0,0,0,318,319,5,35,0,0,319,320,5,41,0,0,320,321,3,72,36,0,321,322,
		5,42,0,0,322,323,3,40,20,0,323,53,1,0,0,0,324,325,5,36,0,0,325,326,3,72,
		36,0,326,327,3,40,20,0,327,55,1,0,0,0,328,329,3,58,29,0,329,330,5,52,0,
		0,330,331,3,68,34,0,331,57,1,0,0,0,332,333,5,40,0,0,333,59,1,0,0,0,334,
		335,5,47,0,0,335,336,3,62,31,0,336,337,5,48,0,0,337,61,1,0,0,0,338,341,
		...
		346,3,58,29,0,346,347,5,20,0,0,347,348,3,72,36,0,348,349,5,84,0,0,349,
		350,3,72,36,0,350,67,1,0,0,0,351,352,6,34,-1,0,352,353,5,47,0,0,353,354,
		3,68,34,0,354,355,5,48,0,0,355,363,1,0,0,0,356,357,5,40,0,0,357,358,5,
		70,0,0,358,359,3,68,34,0,359,360,5,72,0,0,360,363,1,0,0,0,361,363,5,40,
		0,0,362,351,1,0,0,0,362,356,1,0,0,0,362,361,1,0,0,0,363,372,1,0,0,0,364,
		365,10,3,0,0,365,367,5,47,0,0,366,368,3,76,38,0,367,366,1,0,0,0,367,368,
		1,0,0,0,368,369,1,0,0,0,369,371,5,48,0,0,370,364,1,0,0,0,371,374,1,0,0,
		0,372,370,1,0,0,0,372,373,1,0,0,0,373,69,1,0,0,0,374,372,1,0,0,0,375,380,
		3,72,36,0,376,377,5,50,0,0,377,379,3,72,36,0,378,376,1,0,0,0,379,382,1,
		0,0,0,380,378,1,0,0,0,380,381,1,0,0,0,381,71,1,0,0,0,382,380,1,0,0,0,383,
		384,6,36,-1,0,384,385,5,40,0,0,385,387,5,41,0,0,386,388,3,70,35,0,387,
		386,1,0,0,0,387,388,1,0,0,0,388,389,1,0,0,0,389,394,5,42,0,0,390,391,7,
		0,0,0,391,394,3,72,36,8,392,394,3,76,38,0,393,383,1,0,0,0,393,390,1,0,
		0,0,393,392,1,0,0,0,394,422,1,0,0,0,395,396,10,12,0,0,396,397,5,53,0,0,
		397,421,3,72,36,13,398,399,10,7,0,0,399,400,5,79,0,0,400,421,3,72,36,7,
		...
		3,72,36,5,410,411,10,3,0,0,411,412,5,64,0,0,412,421,3,72,36,4,413,414,
		10,2,0,0,414,415,5,63,0,0,415,421,3,72,36,3,416,417,10,11,0,0,417,421,
		...
		426,428,5,41,0,0,427,429,3,70,35,0,428,427,1,0,0,0,428,429,1,0,0,0,429,
		430,1,0,0,0,430,431,5,42,0,0,431,75,1,0,0,0,432,443,3,78,39,0,433,443,
		3,98,49,0,434,443,3,60,30,0,435,443,3,58,29,0,436,437,5,41,0,0,437,438,
		3,72,36,0,438,439,5,42,0,0,439,443,1,0,0,0,440,443,3,36,18,0,441,443,3,
		...
		1,0,0,0,448,79,1,0,0,0,449,450,5,24,0,0,450,463,3,68,34,0,451,460,5,41,
		0,0,452,457,3,22,11,0,453,454,5,50,0,0,454,456,3,22,11,0,455,453,1,0,0,
		...
		42,0,0,463,451,1,0,0,0,463,464,1,0,0,0,464,476,1,0,0,0,465,466,5,43,0,
		0,466,471,3,82,41,0,467,468,5,50,0,0,468,470,3,82,41,0,469,467,1,0,0,0,
		470,473,1,0,0,0,471,469,1,0,0,0,471,472,1,0,0,0,472,474,1,0,0,0,473,471,
		1,0,0,0,474,475,5,44,0,0,475,477,1,0,0,0,476,465,1,0,0,0,476,477,1,0,0,
		0,477,81,1,0,0,0,478,479,3,58,29,0,479,480,5,49,0,0,480,481,3,72,36,0,
		481,83,1,0,0,0,482,483,5,47,0,0,483,484,3,72,36,0,484,485,5,48,0,0,485,
		85,1,0,0,0,486,492,5,39,0,0,487,492,3,104,52,0,488,492,3,102,51,0,489,
		492,3,100,50,0,490,492,5,97,0,0,491,486,1,0,0,0,491,487,1,0,0,0,491,488,
		1,0,0,0,491,489,1,0,0,0,491,490,1,0,0,0,492,87,1,0,0,0,493,494,5,70,0,
		0,494,495,3,96,48,0,495,496,5,50,0,0,496,497,3,96,48,0,497,498,5,50,0,
		0,498,499,3,92,46,0,499,500,5,72,0,0,500,89,1,0,0,0,501,502,5,70,0,0,502,
		503,3,96,48,0,503,504,5,50,0,0,504,505,3,96,48,0,505,506,5,72,0,0,506,
		534,1,0,0,0,507,508,5,70,0,0,508,509,3,96,48,0,509,510,5,50,0,0,510,511,
		3,96,48,0,511,512,5,50,0,0,512,513,3,92,46,0,513,514,5,50,0,0,514,515,
		5,72,0,0,515,534,1,0,0,0,516,517,5,70,0,0,517,518,3,96,48,0,518,519,5,
		50,0,0,519,520,3,96,48,0,520,521,5,50,0,0,521,522,3,96,48,0,522,523,5,
		50,0,0,523,528,3,96,48,0,524,525,5,50,0,0,525,527,3,96,48,0,526,524,1,
		0,0,0,527,530,1,0,0,0,528,526,1,0,0,0,528,529,1,0,0,0,529,531,1,0,0,0,
		530,528,1,0,0,0,531,532,5,72,0,0,532,534,1,0,0,0,533,501,1,0,0,0,533,507,
		...
		539,93,1,0,0,0,540,541,5,40,0,0,541,542,5,52,0,0,542,543,5,40,0,0,543,
		95,1,0,0,0,544,547,3,94,47,0,545,547,3,72,36,0,546,544,1,0,0,0,546,545,
		1,0,0,0,547,97,1,0,0,0,548,549,3,86,43,0,549,99,1,0,0,0,550,554,5,109,
		0,0,551,554,5,110,0,0,552,554,5,108,0,0,553,550,1,0,0,0,553,551,1,0,0,
		0,553,552,1,0,0,0,554,101,1,0,0,0,555,556,7,5,0,0,556,103,1,0,0,0,557,
		559,5,93,0,0,558,560,7,6,0,0,559,558,1,0,0,0,559,560,1,0,0,0,560,567,1,
		0,0,0,561,567,5,94,0,0,562,567,5,95,0,0,563,567,5,96,0,0,564,567,5,101,
		0,0,565,567,5,102,0,0,566,557,1,0,0,0,566,561,1,0,0,0,566,562,1,0,0,0,
		566,563,1,0,0,0,566,564,1,0,0,0,566,565,1,0,0,0,567,105,1,0,0,0,568,569,
		5,40,0,0,569,107,1,0,0,0,570,571,5,40,0,0,571,572,5,53,0,0,572,573,5,40,
		0,0,573,109,1,0,0,0,574,575,5,88,0,0,575,111,1,0,0,0,576,577,5,17,0,0,
		577,580,5,40,0,0,578,579,5,20,0,0,579,581,3,116,58,0,580,578,1,0,0,0,580,
		581,1,0,0,0,581,582,1,0,0,0,582,583,5,49,0,0,583,587,5,43,0,0,584,586,
		3,44,22,0,585,584,1,0,0,0,586,589,1,0,0,0,587,585,1,0,0,0,587,588,1,0,
		0,0,588,590,1,0,0,0,589,587,1,0,0,0,590,591,5,44,0,0,591,113,1,0,0,0,592,
		593,5,40,0,0,593,594,5,52,0,0,594,597,5,17,0,0,595,596,5,20,0,0,596,598,
		3,116,58,0,597,595,1,0,0,0,597,598,1,0,0,0,598,599,1,0,0,0,599,600,5,49,
		0,0,600,601,3,72,36,0,601,602,5,51,0,0,602,115,1,0,0,0,603,606,5,40,0,
		0,604,606,3,110,55,0,605,603,1,0,0,0,605,604,1,0,0,0,606,117,1,0,0,0,607,
		608,5,40,0,0,608,609,5,52,0,0,609,610,5,30,0,0,610,611,5,49,0,0,611,612,
		5,29,0,0,612,613,5,41,0,0,613,614,3,110,55,0,614,615,5,42,0,0,615,616,
		5,51,0,0,616,119,1,0,0,0,53,121,126,132,138,143,145,163,181,184,203,211,
