...
public partial class FifthParser : FifthParserBase {
	...
	public const int
		...
		SPARQL_INTERP_START=138, SPARQL_VAR=139, SPARQL_TEXT=140, SPARQL_QUESTION=141, 
		SPARQL_SINGLE_OPEN_BRACE=142, SPARQL_SINGLE_CLOSE_BRACE=143, SPARQL_CLOSE_ANGLE=144;
	public const int
	...
	private static readonly string[] _SymbolicNames = {
		...
		"SPARQL_VAR", "SPARQL_TEXT", "SPARQL_QUESTION", "SPARQL_SINGLE_OPEN_BRACE", 
		"SPARQL_SINGLE_CLOSE_BRACE", "SPARQL_CLOSE_ANGLE"
	};
	...
	public SparqlLiteralContext sparqlLiteral() {
		...
		try {
			...
			ErrorHandler.Sync(this);
			_la = TokenStream.LA(1);
			while (((((_la - 138)) & ~0x3f) == 0 && ((1L << (_la - 138)) & 63L) != 0)) {
				{
				{
				State = 721;
	...
	public partial class SparqlLiteralContentContext : ParserRuleContext {
		...
		[System.Diagnostics.DebuggerNonUserCode] public ITerminalNode SPARQL_VAR() { return GetToken(FifthParser.SPARQL_VAR, 0); }
		[System.Diagnostics.DebuggerNonUserCode] public ITerminalNode SPARQL_QUESTION() { return GetToken(FifthParser.SPARQL_QUESTION, 0); }
	...
	public SparqlLiteralContentContext sparqlLiteralContent() {
		...
		try {
			...
			case SPARQL_VAR:
				...
				break;
			case SPARQL_QUESTION:
				EnterOuterAlt(_localctx, 3);
				{
				State = 731;
				Match(SPARQL_QUESTION);
				}
				break;
	...
	private static int[] _serializedATN = {
		...
		0,0,0,724,725,1,0,0,0,725,727,1,0,0,0,726,724,1,0,0,0,727,728,5,144,0,
		0,728,121,1,0,0,0,729,736,5,140,0,0,730,736,5,139,0,0,731,736,5,141,0,
		0,732,736,5,142,0,0,733,736,5,143,0,0,734,736,3,124,62,0,735,729,1,0,0,
