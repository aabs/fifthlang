...
public static class FifthParserManager
{
    ...
    public static AstThing ParseAndAnnotate<T>(ICharStream source)
        where T : AstThing
    {
    ...
    public static AstThing ParseToAst<T>(ICharStream source)
        where T : AstThing
    {
    ...
    public static IAstThing ParseBlockToAst(ICharStream source)
    {
    ...
    public static IAstThing ParseExpressionListToAst(ICharStream source)
    {
    ...
    public static IAstThing ParseExpressionToAst(ICharStream source)
    {
    ...
    public static IAstThing ParseFunctionDeclToAst(ICharStream source)
    {
    ...
    public static IAstThing ParseProgramToAst(ICharStream source)
    {
