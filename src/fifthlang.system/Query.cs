...
public sealed class Query
{
    ...
    /// </summary>
    internal SparqlQuery UnderlyingQuery { get; }
    ...
    /// </summary>
    private static QueryType MapQueryType(SparqlQueryType dotNetType)
    {
        return dotNetType switch
        {
            SparqlQueryType.Select => QueryType.Select,
            SparqlQueryType.Construct => QueryType.Construct,
            SparqlQueryType.Ask => QueryType.Ask,
            SparqlQueryType.Describe => QueryType.Describe,
