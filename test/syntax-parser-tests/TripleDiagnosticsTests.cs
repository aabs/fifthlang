...
public class TripleDiagnosticsTests
{
    ...
    {
        const string code = "alias ex as <http://example.org/>; main(): int { a: triple = <ex:s, ex:p>; return 0; }";
    ...
    {
        const string code = "alias ex as <http://example.org/>; main(): int { b: triple = <ex:s, ex:p, ex:o, ex:x>; return 0; }";
        var result = ParseHarnessed(code);
        Codes(result).Should().Contain("TRPL001");
    }
    ...
    {
        const string code = "alias ex as <http://example.org/>; main(): int { c: triple = <ex:s, ex:p, ex:o,>; return 0; }";
        var result = ParseHarnessed(code);
        Codes(result).Should().Contain("TRPL001");
    }
    ...
    {
        const string code = "alias ex as <http://example.org/>; main(): int { g: graph = <ex:s, ex:p, []>; return 0; }";
        var result = ParseHarnessed(code);
        result.Root.Should().NotBeNull();
    ...
    {
        const string code = "alias ex as <http://example.org/>; main(): int { t: triple = <ux:s, ex:p, ex:o>; return 0; }";
        var result = ParseHarnessed(code);
        result.Root.Should().NotBeNull();
    }
}
